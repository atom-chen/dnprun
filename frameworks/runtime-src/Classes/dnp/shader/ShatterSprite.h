...
//        m_initalFrageScale=4.5;
	...
	bool setShader();
    void startShatter(float time);
    
    static ShatterSprite* create(const char* $pszFileName);
    static ShatterSprite* create(const char* $pszFileName, const Rect& $rect);
    static ShatterSprite* createWithSpriteFrame(SpriteFrame* $pSpriteFrame);
    static ShatterSprite* createWithSpriteFrameName(const char* $pszSpriteFrameName);
protected:
	void createShatter();
	void resetShatter();
