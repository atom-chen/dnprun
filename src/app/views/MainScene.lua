...
MainScene._FILTERS = {
	...
	{"CUSTOM"},
	 ...
	 {"CUSTOM", json.encode({frag = "Shaders/example_Flower.fsh",
	 					...
	 					resolution = {480, 320}})},
--	 {"CUSTOM", json.encode({frag = "Shaders/example_outline.fsh",
...
function MainScene:onCreate()
    local layer1= KTTopView:create(self:getApp(),"map")
        :addTo(self)
        layer1:setPositionY(800)
    ...
    local s = crypto.encryptXXTEA("3333ffff", "123")
    print(s)
    --  self:_addUI()
    self:_createFilters()
    self:_showFilter()
    --cc.CustomFilter:create()
end
...
function MainScene:_showFilter()
	...
	self._filterSprite = display.newFilteredSprite("#l-1.png", __filters, __params)
		:align(display.CENTER, display.cx, display.cy)
		:addTo(self, 10)
		self._filterSprite:setScale(2)
